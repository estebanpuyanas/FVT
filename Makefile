...
## location of vendored CxxTest in your repo
CXXTEST_HOME?=$(CURDIR)/tests/cxxtest
...
## CxxTest generator & include dir
CXXTEST_GEN=$(CXXTEST_HOME)/bin/cxxtestgen
CXXTEST_INCLUDE=$(CXXTEST_HOME)

## point to your tests/ folder (not system “test”)
TEST_FILES=$(shell find tests -name "*.cxxtest.hpp")
